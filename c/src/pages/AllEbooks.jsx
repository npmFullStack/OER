...
const MOCK_EBOOKS = [
  ...
  },
  {
    ...
    description: "Learn the basics of network security and cryptography.",
  },
  {
    id: 6,
...
const MOCK_PROGRAMS = [
  { id: 1, acronym: "CS", name: "Computer Science", color: "#3b82f6" },
  { id: 2, acronym: "CE", name: "Computer Engineering", color: "#10b981" },
  { id: 3, acronym: "IT", name: "Information Technology", color: "#f59e0b" },
];
...
const EbookCard = ({ book, viewMode = "grid", onClick }) => {
  ...
  const getCoverUrl = () => {
    ...
    // For demo, return null since we have no actual images
    return null;
  };
