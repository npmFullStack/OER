...
const ImportStudentResearch = () => {
  ...
  const handleFileChange = (e) => {
    ...
    setTimeout(() => {
      setImportPreview({
        ...
        valid: 22,
        invalid: 3,
        columns: ["title", "authors", "category", "year", "abstract"],
        sample: [
          {
            ...
            year: 2024,
            abstract:
              "This study evaluates the usability of e-learning platforms...",
            valid: true,
          },
          {
            title: "Financial Management Practices of Small Enterprises",
            authors: "Reyes, A., Gomez, L.",
            category: "BUSINESS RESEARCH",
            year: 2023,
            abstract: "An analysis of financial management practices...",
            valid: true,
          },
          {
            ...
            year: 2024,
            abstract:
              "This research examines the relationship between social media usage...",
            valid: true,
          },
          {
            title: "", // Missing title
            ...
            category: "INVALID",
            year: 2025, // Invalid year (future)
            abstract: "",
            valid: false,
          },
          {
            title: "Research Without Category",
            authors: "Test Author",
            category: "",
            year: 2024,
            abstract: "Missing category",
            valid: false,
          },
        ],
      });
  ...
  const handleImport = async () => {
    ...
    setLoading(true);
    const loadingToast = toast.loading("Importing research papers...");
    ...
    try {
      ...
      // const response = await studentResearchService.importResearch(formData);

      // Simulate API call
      await new Promise((resolve) => setTimeout(resolve, 3000));

      toast.dismiss(loadingToast);
      toast.success("Research papers imported successfully");

      // Navigate back to student research list
      setTimeout(() => {
      ...
      toast.error(
        error.response?.data?.message || "Failed to import research papers",
      );
    } finally {
      setLoading(false);
    }
                              ...
                              <td className="px-3 py-2">
                                <span
                                  className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${
                                    validCategories.includes(row.category)
                  ...
                  >
                    {loading ? (
                      ...
                      <>
                        ...
                        <span>Import Research Papers</span>
                      </>
                    )}
                  </button>
                  <button
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        "Last Name, Initial" format, separated by commas
                      </p>
                      <p className="text-xs text-gray-400 mt-0.5">
                        Example: Dela Cruz, J., Santos, M.
                      </p>
                    </div>
                  </div>
                ...
                <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-100">
                  ...
                  <ul className="space-y-2 text-xs text-blue-800">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-blue-600">•</span>
                      <span>
                        Title, Authors, Category, and Year are required fields
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-blue-600">•</span>
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-blue-600">•</span>
                      <span>
                        PDF files are not included in import - add separately
                      </span>
                    </li>
                  </ul>
                </div>
