...
const ImportBooks = () => {
  ...
  return (
    <div className="bg-white rounded-xl p-6">
      {/* Header with back button and title - Matching UploadStudentResearch style */}
      <div className="mb-6 flex items-center gap-4">
        ...
        <div>
          ...
          <p className="mt-2 text-gray-600">
            Bulk import books from CSV, Excel, or JSON files
          </p>
        </div>
      </div>
            ...
            {!file ? (
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500 mb-4">
                  Drag and drop your CSV, Excel, or JSON file here, or click to
                  browse
                </p>
                      ...
                      {importPreview.sample.map((row, index) => (
                        ...
                        >
                          <td className="px-3 py-2">
                            <span className={!row.valid ? "text-red-600" : ""}>
                              {row.title || (
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 sticky top-6">
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  desc: "Fill in book details following the required fields",
                },
                {
                  n: 3,
                  title: "Upload & Review",
                ...
                },
                {
                  n: 4,
                  title: "Import Books",
                  desc: "Confirm import to add books to library",
                },
              ].map(({ n, title, desc }) => (
            ...
            <div className="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-100">
              ...
              <ul className="space-y-1 text-xs text-gray-600">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-blue-600">•</span>
                  <span>call_number - Library call number</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-600">•</span>
                  <span>
                    program - Associated program (BSIT, BSBA-FM, etc.)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-600">•</span>
                  <span>shelf_location - Physical location in library</span>
                </li>
              </ul>
            </div>
            ...
            <div className="mt-4 p-4 bg-gray-50 rounded-lg border border-gray-100">
              ...
              <div className="flex flex-wrap gap-1.5">
                {validShelfLocations.slice(0, 6).map((location) => (
                  <span
                    key={location}
                    className="text-xs bg-gray-200 text-gray-700 px-2 py-0.5 rounded"
                  >
                ...
                <span className="text-xs text-gray-400">
                  +{validShelfLocations.length - 6} more
                </span>
              </div>
            </div>
